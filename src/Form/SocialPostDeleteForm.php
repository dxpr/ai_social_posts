...
/**
 * Provides a form for deleting a socials entity.
 *
 * @ingroup socials
 */
class SocialPostDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('socials')->notice('@type: deleted %title.',
      [
